...
<section class="container-fluid px-3 px-md-4 py-4">
    <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-end gap-3 mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Overview of user activity and completion performance.</p>
        </div>
            ...
            <div class="table-responsive">
                <table class="table align-middle table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center py-5 text-muted">No users found for selected filters.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
