    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2><i class="bi bi-pencil"></i> Edit Profile Field</h2>
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">Edit "{{ $profileField->name }}"</h5>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('profile-fields.update', $profileField) }}" method="POST">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                                   id="name" name="name" value="{{ old('name', $profileField->name) }}" required>
                                            @error('name')
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('short_name') is-invalid @enderror" 
                                                   id="short_name" name="short_name" value="{{ old('short_name', $profileField->short_name) }}" 
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('input_type') is-invalid @enderror" 
                                                ...
                                                @foreach($inputTypes as $value => $label)
                                                    <option value="{{ $value }}" 
                                                        {{ old('input_type', $profileField->input_type) === $value ? 'selected' : '' }}>
                                                        {{ $label }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="required" 
                                                       ...
                                                       {{ old('required', $profileField->required) ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="is_active" 
                                                       ...
                                                       {{ old('is_active', $profileField->is_active) ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" 
                                              ...
                                              placeholder="Optional description for this field">{{ old('description', $profileField->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
